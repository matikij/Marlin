...
#define STRING_CONFIG_H_AUTHOR "(matik, Ender-3)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
  // Trianglelabs DDE upgrade
    #define DEFAULT_Kp 14.26
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 38, 0, -1.76 }
...
#define X_BED_SIZE 231 // Adjusted from 235 because of DDE extension
#define Y_BED_SIZE 220 // Adjusted from 235 because of DDE extension
...
#define PREHEAT_2_FAN_SPEED   178 // 70%, Value from 0 to 255
